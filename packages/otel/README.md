...
OpenTelemetry bridge for [@emit-io/core](https://github.com/Emit-io/emit) — emit OTel spans for analytics events and bridge structured logs into the OTel Logs API.
